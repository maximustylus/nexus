...
const AppGuide = ({ isOpen, onClose }) => {
    ...
    return (
        // 👇 FIX 1: bottom-[100px] pushes it above the mobile tab bar, w-[calc(100%-2rem)] makes it fit mobile screens
        <div className="fixed bottom-[100px] md:bottom-6 left-4 md:left-6 z-[90] w-[calc(100%-2rem)] md:w-80 bg-slate-900 border border-slate-700 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)] overflow-hidden animate-in slide-in-from-bottom-8 duration-500">
