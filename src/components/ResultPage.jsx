...
// ─── PRIMARY ACTION BANNER CONFIG (Multilingual Update) ───────────────────────
const CTA_BANNER = {
  URGENT: { 
    emoji: '⚠️', bg: 'bg-rose-50 dark:bg-rose-950/40 border-rose-200 dark:border-rose-800', label: 'bg-rose-600', text: 'text-rose-800 dark:text-rose-200', 
    action: {
      en: 'Consult your GP before starting any exercise. Mention your PAVS result at your visit.',
      ms: 'Sila berjumpa doktor sebelum memulakan sebarang senaman. Maklumkan keputusan PAVS anda.',
      zh: '在开始任何运动前，请先咨询您的全科医生，并告知您的 PAVS 结果。',
      ta: 'எந்தவொரு உடற்பயிற்சியையும் தொடங்கும் முன் உங்கள் மருத்துவரை அணுகவும். உங்கள் PAVS முடிவைக் குறிப்பிடவும்.'
    },
    url: 'https://www.healthiersg.gov.sg/', 
    urlLabel: { en: 'Book via HealthHub', ms: 'Tempah via HealthHub', zh: '通过 HealthHub 预约', ta: 'HealthHub மூலம் பதிவு செய்க' } 
  },
  CLINICAL: { 
    emoji: '🩺', bg: 'bg-amber-50 dark:bg-amber-950/40 border-amber-200 dark:border-amber-800', label: 'bg-amber-500', text: 'text-amber-800 dark:text-amber-200', 
    action: {
      en: 'Enrol in Manage Metabolic Health at Woodlands Active Health Lab - 7 sessions, from SGD 48.',
      ms: 'Daftar dalam program Urus Kesihatan Metabolik di Makmal Active Health Woodlands - 7 sesi, dari SGD 48.',
      zh: '报名参加 Woodlands Active Health 实验室的“管理代谢健康”课程 - 7 节课，SGD 48 起。',
      ta: 'Woodlands Active Health ஆய்வகத்தில் வளர்சிதை மாற்ற சுகாதார திட்டத்தில் பதிவு செய்யவும் - 7 அமர்வுகள், SGD 48 முதல்.'
    },
    url: 'https://www.myactivesg.com/active-health', 
    urlLabel: { en: 'Book at activesg.gov.sg', ms: 'Tempah di activesg.gov.sg', zh: '在 activesg.gov.sg 预约', ta: 'activesg.gov.sg இல் பதிவு செய்க' } 
  },
  COMMUNITY: { 
    emoji: '🏠', bg: 'bg-teal-50 dark:bg-teal-950/40 border-teal-200 dark:border-teal-800', label: 'bg-teal-600', text: 'text-teal-800 dark:text-teal-200', 
    action: {
      en: 'Visit your nearest Active Ageing Centre - walk in, no appointment, activities largely free for residents 60+.',
      ms: 'Kunjungi Pusat Penuaan Aktif (AAC) terdekat - hadir terus, aktiviti percuma untuk warga 60+.',
      zh: '访问离您最近的活跃乐龄中心 (AAC) - 无需预约，60岁以上居民活动大多免费。',
      ta: 'உங்களுக்கு அருகிலுள்ள Active Ageing மையத்தைப் பார்வையிடவும் - முன்பதிவு தேவையில்லை, 60+ வயதினருக்கு இலவசம்.'
    },
    url: 'https://www.aic.sg/care-services/active-ageing-centres', 
    urlLabel: { en: 'Find nearest AAC', ms: 'Cari AAC terdekat', zh: '查找最近的 AAC', ta: 'அருகிலுள்ள AAC ஐக் கண்டறிக' } 
  },
  WELLBEING: { 
    emoji: '🌿', bg: 'bg-violet-50 dark:bg-violet-950/40 border-violet-200 dark:border-violet-800', label: 'bg-violet-600', text: 'text-violet-800 dark:text-violet-200', 
    action: {
      en: 'Connect with your polyclinic\'s mental health support service - this is your most important first step.',
      ms: 'Dapatkan perkhidmatan sokongan kesihatan mental poliklinik anda - ini adalah langkah pertama yang paling penting.',
      zh: '联系您综合诊所的心理健康支持服务 - 这是您最重要的一步。',
      ta: 'உங்கள் பாலிகிளினிக்கின் மனநல ஆதரவு சேவையுடன் இணையுங்கள் - இது உங்கள் மிக முக்கியமான முதல் படியாகும்.'
    },
    url: 'https://www.mindline.sg/', 
    urlLabel: { en: 'mindline.sg', ms: 'mindline.sg', zh: 'mindline.sg', ta: 'mindline.sg' } 
  },
  FREE_FIRST: { 
    emoji: '🆓', bg: 'bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800', label: 'bg-emerald-600', text: 'text-emerald-800 dark:text-emerald-200', 
    action: {
      en: 'Register for Start2Move - a completely free 6-session beginner programme via the Healthy 365 app.',
      ms: 'Daftar untuk Start2Move - program pemula 6 sesi percuma melalui aplikasi Healthy 365.',
      zh: '注册 Start2Move - 通过 Healthy 365 应用程序免费参加的 6 节初学者课程。',
      ta: 'Start2Move-க்கு பதிவு செய்யவும் - Healthy 365 ஆப் மூலம் முற்றிலும் இலவச 6-அமர்வு தொடக்க திட்டம்.'
    },
    url: 'https://www.healthhub.sg/programmes/letsmoveit/start2move', 
    urlLabel: { en: 'Register via Healthy 365', ms: 'Daftar via Healthy 365', zh: '通过 Healthy 365 注册', ta: 'Healthy 365 மூலம் பதிவு செய்க' } 
  },
  START: { 
    emoji: '🚀', bg: 'bg-teal-50 dark:bg-teal-950/40 border-teal-200 dark:border-teal-800', label: 'bg-teal-600', text: 'text-teal-800 dark:text-teal-200', 
    action: {
      en: 'Download the Healthy 365 app and search "Start2Move" to register for the free 6-session beginner programme.',
      ms: 'Muat turun aplikasi Healthy 365 dan cari "Start2Move" untuk mendaftar program pemula 6 sesi percuma.',
      zh: '下载 Healthy 365 应用程序并搜索“Start2Move”以注册免费的 6 节初学者课程。',
      ta: 'Healthy 365 ஆப்பை பதிவிறக்கம் செய்து இலவச 6-அமர்வு தொடக்க திட்டத்திற்கு பதிவு செய்ய "Start2Move" ஐ தேடவும்.'
    },
    url: 'https://www.healthhub.sg/programmes/letsmoveit/start2move', 
    urlLabel: { en: 'Register via Healthy 365', ms: 'Daftar via Healthy 365', zh: '通过 Healthy 365 注册', ta: 'Healthy 365 மூலம் பதிவு செய்க' } 
  },
  LEVEL_UP: { 
    emoji: '💪', bg: 'bg-teal-50 dark:bg-teal-950/40 border-teal-200 dark:border-teal-800', label: 'bg-teal-600', text: 'text-teal-800 dark:text-teal-200', 
    action: {
      en: 'Book a Strength 2.0 or Balance & Muscular Fitness session at Woodlands Active Health Lab, from SGD 6.',
      ms: 'Tempah sesi Kekuatan 2.0 atau Keseimbangan di Makmal Active Health Woodlands, dari SGD 6.',
      zh: '在 Woodlands Active Health 实验室预约力量 2.0 或平衡与肌肉健身课程，SGD 6 起。',
      ta: 'Woodlands Active Health ஆய்வகத்தில் வலிமை 2.0 அல்லது தசை உடற்பயிற்சி அமர்வை பதிவு செய்யவும், SGD 6 முதல்.'
    },
    url: 'https://www.myactivesg.com/active-health', 
    urlLabel: { en: 'Book at activesg.gov.sg', ms: 'Tempah di activesg.gov.sg', zh: '在 activesg.gov.sg 预约', ta: 'activesg.gov.sg இல் பதிவு செய்க' } 
  },
  ADVANCED: { 
    emoji: '⚡', bg: 'bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800', label: 'bg-emerald-600', text: 'text-emerald-800 dark:text-emerald-200', 
    action: {
      en: 'Try the free HIIT Workout Library on HealthHub, or book a Perform 2.0 session at Woodlands Active Health Lab.',
      ms: 'Cuba senaman HIIT percuma di HealthHub, atau tempah sesi Perform 2.0 di Makmal Active Health Woodlands.',
      zh: '尝试 HealthHub 上免费的 HIIT 锻炼库，或在 Woodlands Active Health 实验室预约 Perform 2.0 课程。',
      ta: 'HealthHub-இல் இலவச HIIT உடற்பயிற்சிகளை முயற்சிக்கவும் அல்லது Perform 2.0 அமர்வை பதிவு செய்யவும்.'
    },
    url: 'https://www.healthhub.sg/programmes/letsmoveit', 
    urlLabel: { en: 'HealthHub Move It', ms: 'HealthHub Move It', zh: 'HealthHub Move It', ta: 'HealthHub Move It' } 
  },
};
  ...
  return (
    <div className={`p-5 rounded-2xl border ${config.bg}`}>
      ...
      <p className={`text-sm font-semibold leading-relaxed mb-3 ${config.text}`}>
        <span className="text-lg mr-2">{config.emoji}</span>{config.action[lang] || config.action.en}
      </p>
      <a
        href={config.url}
        target="_blank"
...
export default function ResultPage() {
  ...
  const handleShare = async () => {
    ...
    const sharePrefix = t.sharePrefix || 'My NEXUS AURA result:';
    const topRec      = t.shareTopRec || 'Primary Action:';
    const pathway     = t.sharePathway || 'Discover your community health pathway at NEXUS:';
    
    const shareText = `${sharePrefix} ${tierLabel}.\n\n${topRec} ${actionText}\n\n${pathway}`;
