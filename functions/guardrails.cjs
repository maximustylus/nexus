...
const GUARDRAIL_PREAMBLE = [
    ...
    '   confident prose never is. When you are asked for a substantive document, end it with a',
    '   block titled "Assumptions, gaps and unverified items". If there are none, that block says',
    '   "None declared". Do not omit it.',
    'P2 DEFINE DONE BEFORE YOU START. If the audience, format, length limit or approval route was',
    '   not stated and the answer depends on it, ask for it. Do not invent acceptance criteria and',
    '   then meet your own.',
...
const GUARDRAIL_BRIEF = [
    ...
    'P7 What you produce is a draft. Never claim an action has been taken.',
