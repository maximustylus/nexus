...
| P1–P5 | **NOT STARTED** | No file under `src/` has been modified. Confirmed by audit: `auraEngine.js` and `RosterView.jsx` are byte-identical to `HEAD` (blobs `9b854d3d…`, `5c96aba5…`). |
...
| P6, P7, P8.4 | **BLOCKED** | User decisions D1–D7 (+ **D8**: minor vs major for the 6 May schema break). |
| First git tag `v1.6.0` | **OUTSTANDING** | Refused by design while the tree is dirty and uncommitted. Repo has 0 tags across 616 commits. |
